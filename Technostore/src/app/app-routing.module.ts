...
const routes: Routes = [
  ...
  {path: 'user/edit', component: EditUserComponent, canActivate: [AuthGuardService, AdminAuthGuardService]},
  ...
  {path: 'products/create', component: CreateProductComponent, canActivate: [AuthGuardService, AdminAuthGuardService]},
  {path: 'products/:id/edit', component: EditProductComponent, canActivate: [AuthGuardService, AdminAuthGuardService]},
